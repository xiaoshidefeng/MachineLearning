...
train_dir = 'D:/program/pythonProject/MachineLearning/kaggle/DogCats/data/'
logs_train_dir = 'D:/program/pythonProject/MachineLearning/kaggle/DogCats/tmp/'  # 记录训练过程与保存模型
